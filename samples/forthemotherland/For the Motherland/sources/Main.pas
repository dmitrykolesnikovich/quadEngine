...
begin
 ...
 // FMainMenuEngine.MMStartGame.OnEnter := NewGame;
  ...
  FMainMenuEngine.MMlvl1.OnEnter := lvl1;
  FMainMenuEngine.MMlvl2.OnEnter := lvl2;
  FMainMenuEngine.MMlvl3.OnEnter := lvl3;
  FMainMenuEngine.MMlvl4.OnEnter := lvl4;
  FMainMenuEngine.MMlvl5.OnEnter := lvl5;
  FMainMenuEngine.MMlvl6.OnEnter := lvl6;
