...
begin
  ...
  for Y := 1 to H - 2 do
    for X := 1 to W - 2 do
      if Assigned(List[X, Y].Units) and (List[X, Y].Units.Player = APlayer) and (List[X, Y].Units.HP > 0) then
        inc(Result);
end;
