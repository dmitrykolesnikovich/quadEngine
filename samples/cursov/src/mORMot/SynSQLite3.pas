...
type
  ...
  public
    function FieldBoolean(Col: Integer): Boolean;
    function FieldString(Col: Integer): String;
    procedure Bind(Param: Integer; Value: Boolean); overload;
...
function TSQLRequest.FieldBoolean(Col: Integer): Boolean;
begin
  Result := FieldInt(Col) = 1;
end;

function TSQLRequest.FieldString(Col: Integer): String;
begin
  Result := UTF8ToString(FieldUTF8(Col));
end;

procedure TSQLRequest.Bind(Param: Integer; Value: Boolean);
begin
  sqlite3_check(RequestDB,sqlite3_bind_Int(Request,Param,Integer(Value)));
end;
