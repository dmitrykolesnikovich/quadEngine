...
type
  ...
  IQuadDevice = interface(IUnknown)
    ...
    /// <summary>Creates a rendertarget within specified <see cref="IQuadTexture"/>.</summary>
    /// <param name="AWidth">Width of rendertarget.</param>
    /// <param name="AHeight">Height of rendertarget.</param>
    /// <param name="AQuadTexture">Pointer to declared <see cref="IQuadTexture"/>. If it not created this function will create, if not then it will use existing one.</param>
